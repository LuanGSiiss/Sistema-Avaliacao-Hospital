                ...
                if (dadosResposta.status === 'sucesso') {
                    ...
                    if (!conteudo || !conteudo.dispositivos || conteudo.dispositivos.length === 0) {
                        ...
                        conteudo.dispositivos.forEach( dispositivo => {
                            ...
                            let acoes = `
                            <a href="./dispositivo/alterar/${dispositivo.id_dispositivo}" class="botaoAcao alterar">Alterar</a>
                            <a href="./dispositivo/visualizar/${dispositivo.id_dispositivo}" class="botaoAcao visualizar">Visualizar</a>
...
//Exclusão
function mensagemExcluir(idDispositivo) {
...
function excluirDispositivo(idDispositivo) {
    ...
    const func_assinc = new XMLHttpRequest();
    func_assinc.open("DELETE", `./dispositivo/excluir/${idDispositivo}`, true);
    func_assinc.onload = function () {
        if (func_assinc.status === 200) {
